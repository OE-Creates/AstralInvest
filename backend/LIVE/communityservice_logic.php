<?php
    ...
    function DisplayCommunityServiceTotal()
    {
        ...
        if ($_SERVER['REQUEST_URI'] == "/pages/communityservice01.php")
        {
        ...
        else if($_SERVER['REQUEST_URI'] == "/pages/communityservice02.php")
        {
        ...
        else if ($_SERVER['REQUEST_URI'] == "/pages/communityservice03.php")
        {
        ...
        else if ($_SERVER['REQUEST_URI'] == "/pages/communityservice04.php")
        {
