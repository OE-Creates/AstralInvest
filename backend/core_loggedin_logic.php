<?php
	...
	{
		if ($_SESSION["user_verifystatus"] != 1 && $_SERVER['REQUEST_URI'] != "/php%20projects/AstralInvest/pages/verifyaccount.php") //Change the URI to '/pages/verifyaccount.php' when moving to live site (DELETE THIS)
		{
			$conn->close();
		...
		if ($_SESSION["user_verifystatus"] != 0 && $_SERVER['REQUEST_URI'] == "/php%20projects/AstralInvest/pages/verifyaccount.php")
		{
			$conn->close();
