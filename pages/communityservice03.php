...
<html lang="en">
	...
	<body onload="FillCommServiceTypeC()">
						...
						<div class="card-body pb-0">
							...
							<div class="row">
								<div class="col-md">
									<div class="card mb-3">
										<div class="card-body">
											<h6 class="card-title">Support our Health Facilities</h6>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="card h-100">
														<div class="card-body">
															<h6 class="card-title">Help us provide Medical Support</h6>
															<img src="../img/cservice_03.jpg" class="w-100" alt="..." style="height: 200px;" />
															<hr class="my-3">
