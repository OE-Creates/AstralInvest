...
<html lang="en">
	...
	<body onload="FillCommServiceTypeD()">
						...
						<div class="card-body pb-0">
							...
							<div class="row">
								<div class="col-md">
									<div class="card mb-3">
										<div class="card-body">
											<h6 class="card-title">Enrich the Community</h6>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="card h-100">
														<div class="card-body">
															<h6 class="card-title">Foster and nuture a great Community</h6>
															<img src="../img/cservice_04.jpg" class="w-100" alt="..." style="height: 200px;" />
															<hr class="my-3">
