...
<html lang="en">
	...
	<body onload="FillInvestmentType025()"> <!-- onload="DisablePayBtn()"-->
				...
				<div class="col-md-9">
						...
						<div class="card col-md-12 mb-3 box-shadow">
							<div class="card-body pb-0">
								...
								<h5 class="card-title text-primary mb-3">Starter Plan</h5>
								...
								<div class="row">
										...
										<div class="card mb-3">
											<div class="card-body">
												...
												<form method="POST" id="payment-form">
													...
													<div class="d-flex">
														<button type="button" id="pay-minus-btn" class="btn btn-outline-danger mb-3 me-2" onclick="SubtractFarms025()">-</button>
														<input type="number" class="form-control mb-3 me-2" id="cardholder-nooffarms" value="1" disabled/>
														<button type="button" id="pay-pluss-btn" class="btn btn-outline-success mb-3" onclick="AddFarms025()">+</button>
													</div>
									...
									<div class="col-md-5">
										<div class="card mb-3">
											<div class="card-body">
												<h6 class="card-title">Starter Plan</h6>
