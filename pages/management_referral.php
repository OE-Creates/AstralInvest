...
<html lang="en">
	<head>
		...
		<title>AstralInvest | M-Referrals</title>
				...
				<div class="col-md-9">
						...
						<div class="card col-md-12 mb-3 box-shadow">
							<div class="card-body">
								...
								<h5 class="card-title text-primary">Referral Payout Requests</h5>
								<div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Date Requested (UTC)</th>
                                                <th scope="col">Amount Earned ($)</th>
                                                <th scope="col"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php ManagementDisplayReferralList(); ?>
                                        </tbody>
                                    </table>
                                </div>
